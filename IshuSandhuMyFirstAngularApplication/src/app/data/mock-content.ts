...
export const CONTENT: IContent[] = [
    ...
    },
    {
        id: 5,
        title: 'Honda Civic',
        description: 'A compact car that is known for its reliability, fuel efficiency, and affordability.',
        model: 'Civic',
        imgSrc: 'https://th.bing.com/th/id/OIP.m2GpDPzpqN_1MDUI2NIVmQHaE8?pid=ImgDet&rs=1',
        type: 'Gasoline',
        tags: ['Compact', 'Reliable', 'Fuel Efficient'],
        milage:24,
        Date:"04/01/2001"
    },
    {
